...
Проверка на оверфитинг стратегии - нормальная история, когда реальная траектория не отличается от виртуальной цены как например в этом случае
![Alt text](img/alternative_normal.png "Сравнение распределений коэффициента Шарпа на реальной истории и альтернативной для стратегии GigaMomentum")
В случае когда мы сталкиваемся оверфитингом стратегий
![Alt text](img/alternative_overfilt.png "Сравнение распределений коэффициента Шарпа на реальной истории и альтернативной для AI стратегий")
