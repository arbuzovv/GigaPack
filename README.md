...
+ Консолидатор рыночных данных и данных AlgoPak в объект, который мы назвали GigaCandles
+ Стандартные технические индикаторы для удобства пользования
+ И, ключевой элемент: синтетические рыночные данные
...
загрузили все параметры в RandomForestRegressor и безжалостно зафитили in-sample до откровенно стыдного уровня: [подробное исследование](https://rpubs.com/arbuzov/overfitting_ml)
   + **NN, LSTM** - торговый робот на основе рекуррентной нейросеть с долгой краткосрочной памятью и 5 млн параметров на борту: [подробное исследование](https://github.com/arbuzovv/GigaPack/blob/main/AI_LSTM_NN.ipynb)
